...
%% ----------
\begin{frame}{Research output is multiplicative --- Shockley (1957)}
\vspace{0.5em}
\begin{center}
\large
$P \;=\; F_1 \times F_2 \times F_3 \times F_4 \times F_5 \times F_6 \times F_7 \times F_8$
\end{center}
\vspace{0.5em}
\begin{columns}[T]
...
\end{enumerate}
\column{0.48\textwidth}
\begin{enumerate}\small\setlength\itemsep{0.2em}\setcounter{enumi}{4}
...
\end{columns}
\vspace{0.5em}
\emphbox{Multiplicative: any factor at zero kills output. \;Small gains across several factors compound dramatically.}
\end{frame}
