...
%% ====================================================================
%% PART 2 — WHAT KIND OF AI?
%% ====================================================================

\begin{frame}{Three kinds of AI assistance}
\vspace{1.0em}
\begin{center}
\renewcommand{\arraystretch}{1.6}
\begin{tabular}{ll}
  \textbf{Chatbot}  & You ask. It answers. Conversation ends. \\[0.2em]
  \textbf{Copilot}  & Sits alongside your work. Suggests completions. \\[0.2em]
  \textbf{Agent}    & Wrapped in a loop. Uses tools. Iterates. Plans. \\
\end{tabular}
\end{center}
\vspace{0.6em}
\begin{center}
...
\begin{frame}{Researchers are already doing this}
\vspace{0.8em}
\begin{center}
\color{warmgray}
Two messages I received this week.
\end{center}
\vspace{0.6em}
\begin{columns}[T]
...
\small\color{slate}
\textbf{Friend 1:}\\[0.3em]
\textit{[Screenshot: message from Pedro --- paste text here]}
\end{beamercolorbox}

\column{0.48\textwidth}
\begin{beamercolorbox}[rounded=true,sep=8pt,wd=\linewidth]{block body}
\small\color{slate}
\textbf{Friend 2:}\\[0.3em]
\textit{[Screenshot: message from Bacon --- paste text here]}
\end{beamercolorbox}
\end{columns}
\end{frame}
