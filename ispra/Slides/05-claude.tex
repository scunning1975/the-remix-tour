...
\begin{enumerate}\setlength\itemsep{0.45em}
  \item Pose a good problem
  \item Work effectively on it
  \item Recognize a worthwhile result
  \item Know when to stop
\end{enumerate}
\column{0.48\textwidth}
\begin{enumerate}\setlength\itemsep{0.45em}\setcounter{enumi}{4}
  \item Write it up clearly
  \item Profit from criticism
  \item Submit the work
  \item Persist through revision
\end{enumerate}
\end{columns}
\vspace{0.6em}
\begin{center}\color{warmgray}\small
