...
then \emph{conditioning on sex} removes the PT bias.\\[0.8em]
\color{warmgray}\small
Several ways to do this:\\[0.3em]
\textbf{Outcome regression} (OR) \quad \textbf{IPW} \quad \textbf{Doubly robust} (DR)
\end{center}
\end{frame}
