# `triple-diff.tex` — Zurich Day 2 (Part 1) Outline
...
- **Audience**: same as Day 1 — UZH PhD students, mixed prior exposure to DDD. Most have seen DiD but not DDD as a *design* (they've seen it as "add an interaction").
...
**To create:**
- `/Users/scunning/the-remix-tour/zurich/decks/triple-diff.tex` — the deck
- `/Users/scunning/the-remix-tour/zurich/decks/code/Triple-Diff/` — folder + 5 scripts above
- `/Users/scunning/the-remix-tour/zurich/decks/figures/triple_diff_*.pdf` — generated figures
