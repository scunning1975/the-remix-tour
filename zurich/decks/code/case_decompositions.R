...
ggsave("/Users/scunning/the-remix-tour/zurich/decks/figures/case_decompositions.pdf",
       combined, width = 11, height = 7.2, device = cairo_pdf)

ggsave("/Users/scunning/the-remix-tour/zurich/decks/figures/case_decompositions.png",
