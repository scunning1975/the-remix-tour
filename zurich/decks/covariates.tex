...
\end{itemize}
\vspace{0.3em}
\meta{Source: Imbens \& Rubin (2015), \textit{Causal Inference for Statistics, Social, and Biomedical Sciences}.}
\end{frame}

%% ---------- L1-F2b: balance — normalized differences ----------
...
%% ---------- L1-F2c: balance — the two jobs of a confounder ----------
...
\end{enumerate}
\vspace{0.5em}
The balance check only diagnoses \textbf{(1)}.
\vspace{0.4em}
\begin{itemize}\small
