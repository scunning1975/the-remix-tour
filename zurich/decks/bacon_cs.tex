...
%% ---------- Slide 5: Bacon decomposes the -3.08 ----------
\begin{frame}{Inside the $-3.08$: 156 components, two competing forces}
\vspace{0.5em}
Bacon (2021) decomposes the $-3.08$ TWFE coefficient into 156 underlying 2$\times$2 components.
...
\begin{itemize}
  ...
  \vspace{0.3em}
  \item Drop those terms: the rest averages $-5.44$, very close to the event-study average of $-4.92$ in the figure on the previous slide.
\end{itemize}

\vspace{0.7em}
\textbf{The puzzle.} \;Same data, same regression --- but the single TWFE coefficient ($-3.08$) is masking a $+3.51$ vs.\ $-5.44$ split. \;\highlight{Why?}

\vspace{0.4em}
That's the question this morning.
\meta{Goodman-Bacon, A.\ (2021), \textit{J.\ Econometrics} 225(2): 254--277. \;Decomposition in Fig.\ 6 of the paper.}
\end{frame}
