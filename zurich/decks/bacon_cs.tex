...
\vspace{-0.4em}
\begin{center}\small\color{warmgray}\itshape
$\widehat{\beta}^{\text{TWFE}}$ converges to its estimand at $-3.08$ (LLN/CLT). \;That much is unbiased. \;\highlight{Even when parallel trends holds}, the bias is $-\Delta\text{ATT}_k$ --- the dynamic-heterogeneity term from already-treated cohorts being used as controls. \;Sign unknown.
\end{center}
\end{frame}
