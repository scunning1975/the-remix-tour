%% basics.tex — Zurich Day 1: Advanced Topics in Applied Causal Inference
%% Scott Cunningham, University of Zurich, May 11, 2026
%%
...
\remixtitleframe
  ...
  {University of Zurich \textperiodcentered\ May 11--13, 2026}

%% ---------- Slide 2: The week's shape ----------
\begin{frame}{This week: three days of mine, one of Dan's}
\vspace{0.3em}
\begin{center}
\renewcommand{\arraystretch}{1.5}
\begin{tabular}{@{}p{0.18\textwidth}p{0.65\textwidth}@{}}
\textbf{\color{accent}Mon May 11} & Foundations --- the 2{$\times$}2, parallel trends, event studies \\
\textbf{\color{accent}Tue May 12} & Covariates and staggered adoption \\
\textbf{\color{accent}Wed May 13} & Synthetic control and the frontier \\
\textbf{\color{warmgray}Thu May 14} & \textit{Dan Rees teaches the separate Hidden Curriculum workshop} \\
\end{tabular}
\end{center}
\end{frame}
...
%% ---------- Slide 6: Project APE ----------
\begin{frame}{Production: Project APE, right here at UZH}
\vspace{0.4em}
\begin{itemize}
  \item \highlight{David Yanagizawa-Drott} (UZH Economics, Social Catalyst Lab)
  \item Open experiment in \textit{fully autonomous} economic policy evaluation
  \item 1,000 economics papers generated end-to-end by LLMs --- benchmarked against AER and AEJ papers
  \item \texttt{ape.socialcatalystlab.org}
\end{itemize}
\end{frame}

%% ---------- Slide 7: APE's go-to method ----------
\begin{frame}{Interestingly: APE's go-to method is difference-in-differences}
\vspace{0.5em}
\begin{itemize}
  \item Of all the program evaluation designs an agent could pick, DiD comes up most often
  \item Within DiD: \highlight{Callaway \& Sant'Anna} (2021) is the most common estimator
  \item Production agents are converging on the same designs we are
  \item Which means what you're learning this week is exactly what they're using
\end{itemize}
\end{frame}

%% ---------- Slide 8: But my audits find spec searching ----------
...
\begin{itemize}
  ...
  \item Hired \textbf{Alan Krueger} as a colleague --- a former Orley student himself.
...
\vspace{1.2em}
\begin{itemize}\small
  \item In our 8-person table, look at the $Y_i$ column --- it's $Y_i(1)$ for $D_i=1$ and $Y_i(0)$ for $D_i=0$.
  \item This is all we ever see in the data: \highlight{the realized half}. The counterfactual half is forever missing.
\end{itemize}
\end{frame}
...
\end{itemize}
\vspace{0.4em}
\meta{Walkthrough: \texttt{zurich/labs/Lalonde/Day1\_README.md}. \;Data link in the README. \;Reference scripts: \texttt{lalonde-did.R}, \texttt{lalonde-did-stata.do} (use the no-covariates portions only).}
\end{frame}
