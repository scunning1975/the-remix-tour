%% kuleuven_2x2.tex
%% KU Leuven Difference-in-Differences Workshop — Part 1
%% 2×2, Parallel Trends, Event Studies
%% Scott Cunningham · Baylor University
%%
%% Compile: pdflatex kuleuven_2x2.tex
...
\begin{itemize}\setlength\itemsep{0.6em}
  ...
  \item This is a \highlight{one-day workshop on difference-in-differences}, in three parts, from the basic 2$\times$2 through continuous treatment and staggered adoption.
...
\midrule
Part 1 & 2$\times$2 DiD: parameters, calculations, and identification \\
...
\begin{center}
\Large
Switch to \textbf{kuleuven\_lalonde.pdf}\\[0.8em]
\color{warmgray}\normalsize
