%% kuleuven_lalonde.tex — KU Leuven LaLonde walkthrough: history + four estimators
%% Scott Cunningham, KU Leuven Difference-in-Differences Workshop
...
global X "age agesq educ educsq marr nodegree ///
...
reg re i.post##i.ever_treated ///
    ...
    i.post##c.re74 i.post##c.re75 ///
    i.post##i.u74 i.post##i.u75, robust
\end{lstlisting}
...
gen dr_c = (1-ever_treated)*(phat/(1-phat)) ///
           *(dy - dy_hat)/`pr_treat'
quietly sum dr_t
local mt = r(mean)
quietly sum dr_c
