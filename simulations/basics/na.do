...
replace year = 1990 if year==1 // true baseline
replace year = 1991 if year==2 // year of treatment
replace year = 1992 if year==3 // one year later
replace year = 1993 if year==4 // two years later
...
display "True ATT (constant TE) = " r(mean)

* The truth for the dynamic-effects DGP
su delta_d if year>=1991 & group==1
display "True ATT (dynamic TE, averaged across post-periods) = " r(mean)
