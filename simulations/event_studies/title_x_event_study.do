...
* Clearly positive treatment effect: ATT grows linearly with years since treatment
* For year 6, treated, the effect is (6-5)*0.6 = 0.6
* For year 10, treated, the effect is (10-5)*0.6 = 3.0
gen y1 = y0 + post*treated*(year - 5)*0.6

* Individual treatment effect
gen delta = y1 - y0

* The truth: average ATT over post-period for treated counties
su delta if treated == 1 & post == 1
display "True ATT (averaged across post-period for treated counties) = " r(mean)
