...
\begin{frame}{This afternoon, eight beats}
\vspace{0.3em}
\begin{enumerate}\small
  \item Conditional parallel trends --- the identifying assumption we'll lean on
  \item Outcome regression (Heckman-Ichimura-Todd) --- and the bias OLS-with-controls actually identifies
...
%% (L1-F2 picking-covariates frame moved to Lesson 8.)

%% (L1-F2b, F2c, F2d balance frames moved to Lesson 8.)
