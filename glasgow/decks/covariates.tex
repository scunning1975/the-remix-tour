...
%% =====================================================================
%%  CLOSING EXAMPLE — LaLonde: what conditional PT actually buys you
%% =====================================================================
...
\end{itemize}
\vspace{0.7em}
\highlight{Yes. The canonical case is LaLonde.}
\end{frame}

%% ---------- LL-2: LaLonde 1986, the setup ----------
\begin{frame}{LaLonde (1986)}
\vspace{0.5em}
\textbf{The National Supported Work Demonstration} --- a 1970s RCT for hard-to-employ adults.
\vspace{0.5em}
\begin{itemize}\setlength\itemsep{3pt}
  \item Random assignment to job training. Outcome: real 1978 earnings.
  \item Years on record: \texttt{74}, \texttt{75}, \texttt{78}.
  \item The experiment gives the truth by construction.
\end{itemize}
\vspace{0.5em}
\meta{LaLonde then asked: can observational methods recover that truth on \textit{non}-experimental data?}
\end{frame}
