...
%% ---------- LL-Hist-4: Orley and his students ----------
\begin{frame}{Orley Ashenfelter and his students}
\vspace{0.6em}
Orley was at the center of Princeton's IRS. \;He gave students problems.

\vspace{0.6em}
\begin{itemize}\setlength\itemsep{3pt}
  \item \textbf{Ron Oaxaca} \;$\to$\; the wage decomposition (1973).
  \item \textbf{Josh Angrist} \;$\to$\; Vietnam draft-lottery IV (1990).
  \item \textbf{Bob LaLonde} \;$\to$\; the job-training paper (1986).
\end{itemize}
...
\begin{center}
\small\color{warmgray}\itshape
Foundational papers from one supervisor's office.
\end{center}
\end{frame}
