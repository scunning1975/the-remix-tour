...
| **Audience** | PGR (PhD) students at Adam Smith Business School |
| **Software** | R + Stata (both) |
| **Solo** | Yes |
| **Emphasis** | More hands-on work; expanded synthetic control content |
...
- **`decks/`** — compiled slide PDFs across the 5-day arc (broadest selection in the tour)
- **`labs/`** — R + Stata labs spanning Baker, Cheng-Hoekstra, Concealed Carry, Kline-Moretti, Synth, Augsynth
...
- **Eleonora Brandimarti** (Adam Smith Business School)
- **Arjunan "Subbu" Subramanian** (Adam Smith Business School)
