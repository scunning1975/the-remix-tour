...
\begin{itemize}\small\setlength\itemsep{0.45em}
  ...
  \begin{itemize}\small
    \item {\color{accent}Use long-differences with \texttt{long2} or a universal base.}
  \end{itemize}
...
\begin{center}
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{figures/es_births2.png}
\end{center}
\end{frame}
