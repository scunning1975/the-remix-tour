%% kuleuven_staggered.tex
%% KU Leuven Difference-in-Differences Workshop — Part 3 (staggered adoption)
...
\codechellatitle
  {Staggered Adoption in Difference-in-Differences}
  {A Callaway \& Sant'Anna Checklist, Live, on a Real Project}
